...
class _ChatPageState extends State<ChatPage> {
  ...
  next(_messageRealList, index){
    return Row(
      children: [
        _messageRealList[index]['messageDirection'] == 1 ? const Expanded(child: Text("")) : userAvatar("https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fc-ssl.duitang.com%2Fuploads%2Fitem%2F202005%2F06%2F20200506110929_iajqi.jpg&refer=http%3A%2F%2Fc-ssl.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631409536&t=03cad8232b224d6a7ff11f58ff2be920", 58.0),
        GestureDetector(
          onTap: ()=>{
          },
          child: Container(
        ...
        _messageRealList[index]['messageDirection'] != 1 ? const Expanded(child: Text("")) : userAvatar("https://img.win3000.com/m00/06/ac/9e46cfd309a8aa2c7ef0b16ed50296be_c_345_458.jpg", 58.0),
      ],
    );
  }
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  Future.delayed(const Duration(milliseconds: 10), (){
                    ...
                    if(emojiShowing){
                      scrollController.jumpTo(scrollController.position.maxScrollExtent+250.0);
                    }
                  });
                },
              ),
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      setState(() {
                        _visZhifeiji = true;
                        _messageList.insert(0, {"messageDirection": 1, "content": _messageText.text});
                      });
